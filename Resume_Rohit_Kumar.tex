  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItem{Versatile cellular modem systems engineer with commercialized contributions across major modem areas - SA/NSA, FR1, FR2, NRDC, single-carrier/carrier-aggregation, PDCCH, PDSCH link adaptation.}
        ...
        \resumeItem{Adept at applying feature engineering and prompt engineering techniques to drive effective Generative AI (GenAl)-based root cause analysis and test automation.}
        ...
        \resumeItem{Delivered first NRDC (FR1+FR2) performance test on Consumer Premises Equipment (FWA CPE) with Qualcomm TBS, improving FR1 performance by 10\%+ and test execution cost savings of 80\%+.}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Implemented packet detection, channel estimation, CFO/SFO and Doppler shift compensation algorithms using preambles and pilots.}
          \resumeItemListEnd
          \vspace{-12pt}
      \resumeProjectHeading
...
\section{Technical Skills \& Tools}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Skills}{: 5G Modem Systems, AI/ML, GenAI, Python, C/C++, RF Testing, Automation, Research, Analysis, Algorithms} \\
     \textbf{Tools}{: Keysight PRT, Propsim, QCOM Test Base Station, QXDM, APEX, MATLAB, PyTorch, Git, Altium Designer, Vector Signal Analyzer} \\
    }}
 \end{itemize}
 \vspace{-16pt}
